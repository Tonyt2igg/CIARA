...
image_path = r"D:\CIARA\results\pretrained\test_200\examples\temp_output\input_image_fake2.png"
...
for contour in contours:
    ...
    contour = cv2.approxPolyDP(contour, epsilon=0.9, closed=False)
...
csv_path = r"D:\CIARA\1csv_transfer\CSV\vs_code\waypoints.csv"
