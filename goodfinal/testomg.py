...
def display_generated_images_and_select():
    ...
    styled_image_paths = [
        r"C:\projects\cyclegan\tech\Unpaired-Portrait-Drawing\results\pretrained\test_200\examples\temp_output\input_image_fake1.png",
        r"C:\projects\cyclegan\tech\Unpaired-Portrait-Drawing\results\pretrained\test_200\examples\temp_output\input_image_fake2.png",
        r"C:\projects\cyclegan\tech\Unpaired-Portrait-Drawing\results\pretrained\test_200\examples\temp_output\input_image_fake3.png"
    ]
...
def process_image(img):
    try:
        ...
        output_image_path = r"C:\projects\cyclegan\tech\Unpaired-Portrait-Drawing\results\pretrained\test_200\examples\temp_output\input_image_fake2.png"
        ...
        if sketch is None:
            print(f"Failed to load sketch from {output_image_path}.")
            return []

        # Edge detection and contour simplification
