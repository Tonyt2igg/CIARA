...
input_path = r"D:\CIARA\1csv_transfer\CSV\vscode_custom\custom_drawing.png"  # Full path to the input image
output_dir = r"D:\CIARA\1csv_transfer\CSV\vscode_custom"  # Directory to save processed images
