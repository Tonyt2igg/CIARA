...
input_path = r"D:\CIARA\results\pretrained\test_200\examples\temp_output\input_image_fake2.png"  # Full path to the input image
output_dir = r"D:\CIARA\final\skeleton"  # Directory to save processed images
