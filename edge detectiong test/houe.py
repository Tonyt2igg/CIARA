...
shapes = cv2.imread(r"C:\projects\cyclegan\tech\Unpaired-Portrait-Drawing\results\pretrained\test_200\examples\temp_output\input_image_fake2.png")
...
canny_edges = cv2.Canny(shapes_blurred, 1, 150)
